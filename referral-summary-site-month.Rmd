...
reactable(
  ...
  groupBy = c("MSHS", "SITE", "DEPT_SPECIALTY_NAME", "DEPARTMENT_NAME"),

  columnGroups = list(
    colGroup(name = "", columns = c("MSHS", "SITE", "DEPT_SPECIALTY_NAME", "DEPARTMENT_NAME", "WORKQUEUE_NAME", "WORKQUEUE_ID", "wq_type"),
             headerStyle = list(color = "black", fontSize = "15px"),
             sticky = "left"),
